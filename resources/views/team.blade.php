...
@section('container')
    <!-- Page Banner -->
	<div class="page-banner attorney-banner container-fluid no-padding">
		<!-- Container -->
		<div class="container">
			<div class="col-md-5 no-padding">
				<h3>Kisworo & Partners</h3>
	...
	<!-- Attorney Section -->
	<div id="attorney-section" class="container-fluid no-padding attorney-section blog-page-content">		
		...
		<div class="container">
			...
			<div class="row">
				<div class="attorney-block">
					<div class="col-md-6 col-sm-6 col-xs-12 attorney-left">
						<div class="col-md-6 col-sm-6 col-xs-6 attorney-team-photo no-padding">
							<img src="images/kisworo.jpg" alt="team" />
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6 attorney-team-details">
							<h3>Kisworo, SH. CLI. CTLC. CIRP.</h3>
							<span>Pengacara</span>
							<p>Spesialisasi Corpoate Law, Likuidasi, Hukum Pajak, Pertanahan, Kepailitan, Hukum Perdata Umum dan Pidana.</p>
							<ul>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 attorney-right skill-section">
                            <p><img src="images/icon/tab-ic.png" alt="">
                            Tahun 2010 Direktur Lembaga Pendidikan Advokat IKADIN Bekasi</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2010 Penasihat Pos Bantuan Hukum Pengadilan Negeri Bekasi.</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2009 Ketua DPC IKADIN Bekasi.</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2008 Wakil Sekretaris DPC PERADI Bekasi.</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2007 Rekan di Kantor Hukum Madurani & Partners, Jakarta</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2004 Sekretaris DPC IKADIN Bekasi.</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2004 Rekan di Kantor Hukum Shalih Mangara Sitompul, SH. MH & Rekan, 
                                Jakarta.</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2003 Ketua Bidang Pengabdian Masyarakat DPC IKADIN Bekasi.</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2003 Direktur LBH Patriot Bangsa, Bekasi.</p>
                            <p><img src="images/icon/tab-ic.png" alt="">
                                Tahun 2002 lulus ujian Advokat di Pengadilan Tinggi Jakarta</p>
				...
				<div class="attorney-block">
					<div class="col-md-6 col-sm-6 col-xs-12 attorney-left">
						<div class="col-md-6 col-sm-6 col-xs-6 attorney-team-photo no-padding">
							<img src="images/attorney2.jpg" alt="team"/>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6 attorney-team-details">
